...
import logging
import re
from src.humanizador import humanizar_texto
...
def reprocessar_texto(texto_original, tokenizer, model, detector, evaluator, num_beams, temperature, progress_callback, stop_event, threshold_improvement=0.60, prompt_info=None):
    """
    Reprocessa o texto em pedaços, aplicando humanização e verificando a melhoria.
    """
    # 49
    # Análise inicial do texto completo para ter uma linha de base
