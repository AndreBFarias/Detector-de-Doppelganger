...
class LeftMenu(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.model_menu = customtkinter.CTkOptionMenu(
            self.models_frame, values=["Leve (CPU)", "Equilibrado (CPU)", "Profundo (CPU)"]
        )
        ...
        self.creativity_slider = customtkinter.CTkSlider(
            ...
            from_=0.5,
            to=1.2,
            progress_color=config.ACCENT_GREEN,
            button_color=config.ACCENT_PURPLE,
        ...
        self.input_actions_label = customtkinter.CTkLabel(
            self.input_frame,
            text="Ações de Entrada",
            text_color=config.ACCENT_GREEN,
            font=customtkinter.CTkFont(size=14, weight="bold"),
        )
        ...
        self.output_actions_label = customtkinter.CTkLabel(
            self.output_frame,
            text="Ações de Saída",
            text_color=config.ACCENT_GREEN,
            font=customtkinter.CTkFont(size=14, weight="bold"),
