...
class Banner(customtkinter.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        # "Detector de " (Cinza)
        self.title_part1 = customtkinter.CTkLabel(
            self.title_frame,
            text="Detector de ",
        ...
        self.title_part2 = customtkinter.CTkLabel(
            self.title_frame,
            text="Mimico",
        ...
        self.title_part3 = customtkinter.CTkLabel(
            self.title_frame,
            text=" - Identificador e Humanizador de ",
            text_color=("gray60", "gray70"),
            font=customtkinter.CTkFont(size=22),
        )
        self.title_part3.pack(side="left")

        self.title_part4 = customtkinter.CTkLabel(
            self.title_frame,
            text="IA",
            text_color=config.ACCENT_GREEN,
            font=customtkinter.CTkFont(size=22, weight="bold"),
